...
const TASK_COPY = {
  ...
  watch: {
    Icon: FaClock,
    label: 'Watch 30 minutes on 3Speak',
    hint: 'Any videos. Counted while you are really watching.',
    why: 'It says you are here as a viewer and not only as an uploader. It is the goal most people finish without trying.',
    counts: [
      'Time on 3Speak itself. The same video embedded on another site cannot count.',
      'Once per video. Rewatching one raises its best time, it never adds to it, and no single video can supply the whole half hour on its own.',
      'Real playing time, so speeding a video up is not punished and slowing it down does not stretch it.',
      'On screen. A video left playing in a background tab does not count.',
      'Not your own videos.',
