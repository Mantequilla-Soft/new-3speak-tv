...
const TAG_FEED_URL = import.meta.env.VITE_THREESPEAK_TAG_FEED_URL;
const FEED_URL = import.meta.env.VITE_FEED_URL;
const VIEWS_URL = import.meta.env.VITE_VIEWS_URL;




export { API_URL_FROM_WEST, GRAPHQL_API_URL, VIDEO_CDN_DOMAIN, HIVE_HOST_API, UPLOAD_TOKEN, UPLOAD_URL, TAG_FEED_URL, FEED_URL, VIEWS_URL };