...
export const CHANGELOG = [
  ...
  },
  {
    ...
    date: '2026-09-22',
    summary:
      'Feeds now stay exactly where you left them as you browse. With "hide '
      + 'watched" on, a video still drops out of the feed as soon as you\'ve '
      + 'watched it.',
  },
  {
    version: '1.79.4',
    date: '2026-09-22',
    summary:
      'When you watch a video that is part of a playlist, the playlist strip now '
      + 'sits on its own row under the video details instead of squeezing in next '
      + 'to the channel name and community. Nothing about the playlist controls '
  ...
  },
  {
    ...
    date: '2026-09-18',
    summary:
      'The comments panel now tucks away while a sponsored spot plays in the Shorts '
      + 'feed (/shorts), so the spot has the screen to itself. It reopens exactly as '
      + 'you left it when the next short starts.',
  },
  {
    version: '1.79.0',
    date: '2026-09-16',
  ...
  },
  {
    ...
    date: '2026-08-30',
    summary:
      'You can now set your channel trailer from a video’s Edit screen, not just while '
      + 'uploading. Open Edit on one of your landscape videos and turn on “Channel trailer”. '
      + 'It also shows when a video already is your trailer, so you can turn it off.',
  },
  {
    version: '1.78.56',
    date: '2026-08-27',
  ...
  },
  {
    ...
    date: '2026-08-22',
    summary:
      'Uploads are more reliable on slow and mobile connections. You can now cancel an upload that is not moving, and the upload screen is simpler.',
  },
  {
    version: '1.78.50',
    date: '2026-08-22',
